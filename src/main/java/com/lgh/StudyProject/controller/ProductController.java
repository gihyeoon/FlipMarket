...
public class ProductController {
	...
	public ResponseEntity<String> addProduct(@RequestParam(value = "image") MultipartFile image,
			@RequestParam(value = "productName") String productName, @RequestParam(value = "category") String category,
			@RequestParam(value = "price") int price, @RequestParam(value = "desc") String desc) throws IOException {
